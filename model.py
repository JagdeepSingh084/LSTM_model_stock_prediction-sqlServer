...
from db_connection import fetch_data_from_sqlserver  # Import the new module
app = Flask(__name__)

# Load the dataset from SQL Server
df = fetch_data_from_sqlserver()  # Fetch data from SQL Server
print(type(df['Date']))
